...
integer, parameter:: kq = 1, kr = 5, ks = 6, lcx = 64

!  TPSLQ1 parameters:

integer, parameter:: idb = 2, n = 10, ndp = 5000, ndr = 20, &
  nep = 20 - ndp, nrb = 1000, nwds = int (ndp / mpdpw + 2)
...
integer, parameter:: ipi = 100, ipm = 500, itm = 10000000
