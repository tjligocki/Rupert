...
integer, public, parameter:: mpipl = 10000, mpiplm = 1000

!----------------------------------------------------------------------------

!  *** Do not change the following code (in normal usage).

integer, public, parameter:: mpwds = int (mpipl / mpdpw + 2.d0), mpwdsbt = mpnbt * mpwds, &
  mpwds6 = mpwds + 6, mpwdsm = int (mpiplm / mpdpw + 2.d0), &
  mpwdsmbt = mpnbt * mpwdsm, mpwdsm6 = mpwdsm + 6
