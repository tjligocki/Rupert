...
call mpwrite (6, ndp + 20, ndp, bessel_i (t1, -t2))
call checkmp (nwds, nfile, 1, bessel_i (t1, -t2), eps, err)
errmx = max (err, errmx)
...
call mpwrite (6, ndp + 20, ndp, bessel_in (3, 300.d0*t1))
call checkmp (nwds, nfile, 1, bessel_in (3, 300.d0*t1), eps, err)
errmx = max (err, errmx)

write (6, '(a)') 'bessel_j(t1,-t2) ='
call mpwrite (6, ndp + 20, ndp, bessel_j (t1, -t2))
call checkmp (nwds, nfile, 1, bessel_j (t1, -t2), eps, err)
errmx = max (err, errmx)
...
call mpwrite (6, ndp + 20, ndp, bessel_jn (3, 300.d0*t1))
call checkmp (nwds, nfile, 1, bessel_jn (3, 300.d0*t1), eps, err)
errmx = max (err, errmx)

write (6, '(a)') 'bessel_k(t1,-t2) ='
call mpwrite (6, ndp + 20, ndp, bessel_k (t1, -t2))
call checkmp (nwds, nfile, 1, bessel_k (t1, -t2), eps, err)
errmx = max (err, errmx)
...
call mpwrite (6, ndp + 20, ndp, bessel_kn (3, 300.d0*t1))
call checkmp (nwds, nfile, 1, bessel_kn (3, 300.d0*t1), eps, err)
errmx = max (err, errmx)

write (6, '(a)') 'bessel_y(t1,-t2) ='
call mpwrite (6, ndp + 20, ndp, bessel_y (t1, -t2))
call checkmp (nwds, nfile, 1, bessel_y (t1, -t2), eps, err)
errmx = max (err, errmx)
...
call mpwrite (6, ndp + 20, ndp, bessel_yn (3, 300.d0*t1))
call checkmp (nwds, nfile, 1, bessel_yn (3, 300.d0*t1), eps, err)
errmx = max (err, errmx)
...
call mpwrite (6, ndp + 20, ndp, digamma_be (nbe,be,t1))
call checkmp (nwds, nfile, 1, digamma_be (nbe,be,t1), eps, err)
errmx = max (err, errmx)
...
write (6, '(a)') 'expint(t1) ='
call mpwrite (6, ndp + 20, ndp, expint (t1))
call checkmp (nwds, nfile, 1, expint (t1), eps, err)
errmx = max (err, errmx)
...
call mpwrite (6, ndp + 20, ndp, hurwitz_zetan (3,1.d0/t1))
call checkmp (nwds, nfile, 1, hurwitz_zetan (3,1.d0/t1), eps, err)
errmx = max (err, errmx)

write (6, '(a)') 'hurwitz_zetan_be(nbe,be,5,t1) ='
call mpwrite (6, ndp + 20, ndp, hurwitz_zetan_be (nbe,be,5,t1))
call checkmp (nwds, nfile, 1, hurwitz_zetan_be (nbe,be,5,t1), eps, err)
errmx = max (err, errmx)

write (6, '(a)') 'hypergeom_pfq(np,nq,aa,bb,t1) ='
call mpwrite (6, ndp + 20, ndp, hypergeom_pfq (np,nq,aa,bb,t1))
call checkmp (nwds, nfile, 1, hypergeom_pfq (np,nq,aa,bb,t1), eps, err)
errmx = max (err, errmx)
...
t3 = mpreal (-3.d0, nwds)
call mpwrite (6, ndp + 20, ndp, incgamma (t3, t1))
call checkmp (nwds, nfile, 1, incgamma (t3, t1), eps, err)
errmx = max (err, errmx)
...
write (6, '(a)') 'log10(t1) ='
call mpwrite (6, ndp + 20, ndp, log10 (t1))
call checkmp (nwds, nfile, 1, log10 (t1), eps, err)
errmx = max (err, errmx)
...
call mpwrite (6, ndp + 20, ndp, mpreal (chrx, nwds))
call checkmp (nwds, nfile, 1, mpreal (chrx, nwds), eps, err)
errmx = max (err, errmx)

write (6, '(a)') 'mpreal (chr1, n1, nwds) ='
call mpwrite (6, ndp + 20, ndp, mpreal (chr1, n1, nwds))
call checkmp (nwds, nfile, 1, mpreal (chr1, n1, nwds), eps, err)

write (6, '(a)') 'polygamma(3,1/t1) ='
call mpwrite (6, ndp + 20, ndp, polygamma (3,1.d0/t1))
call checkmp (nwds, nfile, 1, polygamma (3,1.d0/t1), eps, err)
errmx = max (err, errmx)

write (6, '(a)') 'polygamma_be(nbe,be,5,t1) ='
call mpwrite (6, ndp + 20, ndp, polygamma_be (nbe,be,5,t1))
call checkmp (nwds, nfile, 1, polygamma_be (nbe,be,5,t1), eps, err)
errmx = max (err, errmx)
...
call mpwrite (6, ndp + 20, ndp, struve_hn (10, t1))
call checkmp (nwds, nfile, 1, struve_hn (10,t1), eps, err)
errmx = max (err, errmx)
...
call mpwrite (6, ndp + 20, ndp, zeta_be (nbe,be,t1))
call checkmp (nwds, nfile, 1, zeta_be (nbe,be,t1), eps, err)
errmx = max (err, errmx)
...
write (6, 9) d1, i1
9 format (/'Max relative error =',f9.6,'e',i6)
