...
private &
  mpinitwds, mpfixlocr, mpwprecr, mpspacer, mpberner, mppolyadd, mppolysub, &
  mppolydiv, mpbesselinr, mpbesselir, mpbesseljnr, mpbesseljr, mpbesselknr, &
  mpbesselkr, mpbesselynr, mpbesselyr, mpdigammabe, mperfr, mperfcr, mpexpint, &
  mpgammar, mphurwitzzetan, mphurwitzzetanbe, myhypergeompfq, mpincgammar, &
  mppolygamma, mppolygammabe, mppolylogini, mppolylogneg, mppolylogpos, &
  mpstruvehn, mpzetar, mpzetaintr, mpzetabe
