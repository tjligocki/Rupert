...
use mpmodulem
implicit none
double precision d1, d2, rb, second, secondwc, secondwe, tm, tm0, tm1, tmw0, tmw1
integer i, i1, idb, iq, itr, j, j1, k, kq, kr, ks, lcx, n, ndp, &
  ndpm, nep, nepm, nwds, nwdsm
parameter (idb = 2, itr = 1, kq = 0, kr = 8, ks = 10, lcx = 64, &
...
write (6, 2) itr, n, kq, kr, ks, rb, ndp, ndpm, nep, nepm
...
120     continue
  ...
  write (6, 6) tm1 - tm0, secondwe (tmw1 - tmw0)
6 format ('CPU Time =',f12.4/'Wall clock time =',f12.4)
enddo
