...
use mpmodule
implicit none
double precision d1, d2, rb, rm, second, tm, tm0, tm1
integer i, i1, idb, iq, itr, j, j1, k, kq, kr, ks, lcx, n, ndp, nep, nwds
parameter (idb = 2, itr = 1, kq = 1, kr = 5, ks = 6, lcx = 64, &
  n = 15, ndp = 200, nep = 20 - ndp, rb = 100.d0, &
...
double precision d1, d2, d3, d4, dplog10, rb, second, tm0, tm1, times(2)
