...
!   This program demonstrates the tanh-sinh quadrature routine quadts and the
!   initialization routine initqts.  Quadts successively integrates the input
!   function by applying a grid whose size doubles with each iteration, until
!   the accuracy estimate reaches the target precision (ndp1 digits).
...
!   calling quadts.  See the sample functions and the calls to quadts below.
!   Before quadts is called, initqts must be called to initialize the wk and
!   xk arrays.
...
! nwords1  Low precision in words, typically int (ndp1 / mpdpw + 2).
! nwords2  High precision  in words, typically int (ndp2 / mpdpw + 2).

use mpmodule
implicit none
integer i, ndp1, ndp2, neps1, neps2, nq1, nq2, nwords1, nwords2, n1
...
type (mp_real) err, quadts, fun01, fun02, fun03, fun04, fun05, fun06, &
...
tm0 = second ()
t1 = quadts (fun01, x1, x2, nq1, nq2, nwords1, nwords2, neps1, wk, xk)
tm1 = second ()
tm2 = tm2 + (tm1 - tm0)
write (6, 3) tm1 - tm0
...
x2 = mpreal (1.d0, nwords2)
tm0 = second ()
t1 = quadts (fun02, x1, x2, nq1, nq2, nwords1, nwords2, neps1, wk, xk)
tm1 = second ()
tm2 = tm2 + (tm1 - tm0)
write (6, 3) tm1 - tm0
call mpwrite (6, ndp1 + 20, ndp1, t1)
...
tm0 = second ()
t1 = quadts (fun03, x1, x2, nq1, nq2, nwords1, nwords2, neps1, wk, xk)
tm1 = second ()
tm2 = tm2 + (tm1 - tm0)
write (6, 3) tm1 - tm0
call mpwrite (6, ndp1 + 20, ndp1, t1)
...
x2 = mpreal (1.d0, nwords2)
tm0 = second ()
t1 = quadts (fun04, x1, x2, nq1, nq2, nwords1, nwords2, neps1, wk, xk)
tm1 = second ()
tm2 = tm2 + (tm1 - tm0)
write (6, 3) tm1 - tm0
call mpwrite (6, ndp1 + 20, ndp1, t1)
...
x2 = mpreal (1.d0, nwords2)
tm0 = second ()
t1 = quadts (fun05, x1, x2, nq1, nq2, nwords1, nwords2, neps1, wk, xk)
tm1 = second ()
tm2 = tm2 + (tm1 - tm0)
write (6, 3) tm1 - tm0
call mpwrite (6, ndp1 + 20, ndp1, t1)
...
x2 = mpreal (1.d0, nwords2)
tm0 = second ()
t1 = quadts (fun06, x1, x2, nq1, nq2, nwords1, nwords2, neps1, wk, xk)
tm1 = second ()
tm2 = tm2 + (tm1 - tm0)
write (6, 3) tm1 - tm0
call mpwrite (6, ndp1 + 20, ndp1, t1)
...
x2 = mpreal (1.d0, nwords2)
tm0 = second ()
t1 = quadts (fun07, x1, x2, nq1, nq2, nwords1, nwords2, neps1, wk, xk)
tm1 = second ()
tm2 = tm2 + (tm1 - tm0)
write (6, 3) tm1 - tm0
call mpwrite (6, ndp1 + 20, ndp1, t1)
t2 = 2.d0 * sqrt (mpreal (mppic, nwords1)) * gamma (mpreal (0.75d0, nwords1)) &
...
x2 = mpreal (1.d0, nwords2)
tm0 = second ()
t1 = quadts (fun08, x1, x2, nq1, nq2, nwords1, nwords2, neps1, wk, xk)
tm1 = second ()
tm2 = tm2 + (tm1 - tm0)
write (6, 3) tm1 - tm0
call mpwrite (6, ndp1 + 20, ndp1, t1)
...
x2 = mpreal (0.5d0 * mppic, nwords2)
tm0 = second ()
t1 = quadts (fun09, x1, x2, nq1, nq2, nwords1, nwords2, neps1, wk, xk)
tm1 = second ()
tm2 = tm2 + (tm1 - tm0)
write (6, 3) tm1 - tm0
call mpwrite (6, ndp1 + 20, ndp1, t1)
...
x2 = mpreal (0.5d0 * mppic, nwords2)
tm0 = second ()
t1 = quadts (fun10, x1, x2, nq1, nq2, nwords1, nwords2, neps1, wk, xk)
tm1 = second ()
tm2 = tm2 + (tm1 - tm0)
write (6, 3) tm1 - tm0
call mpwrite (6, ndp1 + 20, ndp1, t1)
...
x2 = mpreal (1.d0, nwords2)
tm0 = second ()
t1 = quadts (fun11, x1, x2, nq1, nq2, nwords1, nwords2, neps1, wk, xk)
tm1 = second ()
tm2 = tm2 + (tm1 - tm0)
write (6, 3) tm1 - tm0
call mpwrite (6, ndp1 + 20, ndp1, t1)
...
x2 = mpreal (1.d0, nwords2)
tm0 = second ()
t1 = quadts (fun12, x1, x2, nq1, nq2, nwords1, nwords2, neps1, wk, xk)
tm1 = second ()
tm2 = tm2 + (tm1 - tm0)
write (6, 3) tm1 - tm0
call mpwrite (6, ndp1 + 20, ndp1, t1)
...
x2 = mpreal (1.d0, nwords2)
tm0 = second ()
t1 = quadts (fun13, x1, x2, nq1, nq2, nwords1, nwords2, neps1, wk, xk)
tm1 = second ()
tm2 = tm2 + (tm1 - tm0)
write (6, 3) tm1 - tm0
call mpwrite (6, ndp1 + 20, ndp1, t1)
...
x2 = mpreal (1.d0, nwords2)
tm0 = second ()
t1 = quadts (fun14, x1, x2, nq1, nq2, nwords1, nwords2, neps1, wk, xk)
tm1 = second ()
tm2 = tm2 + (tm1 - tm0)
write (6, 3) tm1 - tm0
call mpwrite (6, ndp1 + 20, ndp1, t1)
...
use mpmodule
implicit none
integer i, ierror, iprint, j, k, k1, ndebug, neps2, nq1, nq2, nwords1
...
function quadts (fun, x1, x2, nq1, nq2, nwords1, nwords2, neps1, wk, xk)
...
integer i, ierror, ip(0:100), iz1, iz2, izx, j, k, k1, k2, n, ndebug, &
  nds, neps1, nq1, nq2, nqq1, nwords1, nwords2
