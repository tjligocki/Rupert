...
#myseed = 141453824 # bad (2,3)
#myseed = 311609856 # bad (2,5)
#myseed = 666888704 # bad (2,11)
#myseed = 894768128 # bad (3,4)
...
while m > 1e-15 and count < 50000:
  ...
  for i in range(n):
    ...
    for j in range(n-1):
      dt[j] += (aver_value-funcs.f(i,t))*funcs.df(i,j,t)/norm
