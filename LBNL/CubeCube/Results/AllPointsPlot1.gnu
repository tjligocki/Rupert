...
GNUTERM = "aqua"
plot "allvalues.txt" using (1.0/$1):(1/$2**2/$1-1) with points pt 0, "allvalues.txt" using (1.0/$1-1):(((17.0+8*(1.0/$1-2.5))/(9.0+8*(1.0/$1-2.5)))*(1/$2**2/$1-1)) with points pt 0 lc 9, "allvalues.txt" using (1.0/$1):(0.0) with points pt 0 lc 1, "allvalues.txt" using (1.0/$1-1):(-0.02) with points pt 0 lc 9, "allvalues.txt" using (1.0/$1-1):((17.0+8*(1.0/$1-2.5))/(9.0+8*(1.0/$1-2.5))) axes x1y2
#    EOF
