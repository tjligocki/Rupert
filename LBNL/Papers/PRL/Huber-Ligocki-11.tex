...
\begin{equation*}
  ...
  \end{matrix}
\end{equation*}
Although the Babylonians had the solution $f(1,2)=\sqrt{2}$\cite{neugebauer}, it is still worth discussing for three reasons: i) features of this geometry have similarities to the general problem, ii) a bound on $f(n-1,n)$ can lead to a bound on $f(n,n+1)$, and iii) a solution to $f(n-1,n)$ can be perturbed to build a solution to $f(n,n+1)$.

By examining this family of numerical lower bounds, one can see the asymptotic law 
...
It is but another short step to consider the {\it generalized Rupert problem} for the pair of dimensions $(m,n)$: What is $f(m,n)$? where
\begin{equation*}
f(m,n) = {\rm the sidelength of the largest m-cube that fits inside a unit n-cube.}
\end{equation*}
...
\hline
2 & 4.14213e-1 & 7.32051e-1        & 1.414213e-0    \\
\hline
3 & 6.06602e-2 & 9.63763e-2        & 1.060660e-0    \\
\hline
4 & 7.43476e-3 & 1.21021e-2        & 1.096376e-0    \\
\hline
5 & 8.39447e-4 & 1.37550e-3        & 1.066018e-0    \\
\hline
6 & 9.34736e-5 & 1.53317e-4        & 1.069165e-0    \\
\hline
7 & 1.03888e-5 & 1.70423e-5        & 1.066491e-0    \\
\hline
8 & 1.15436e-6 & 1.89369e-6        & 1.066768e-0    \\
\hline
\end{tabular}
\end{center}
