...
\noindent It is but another short step to consider the general problem of $f(m,n)$: the sidelength of the largest $m$-cube that fits inside a unit $n$-cube.  
...
There are three separate systems of arrays to keep in mind in the general problem: vertices (V), edge vectors (E) and rotations (R). Henceforth, when discussing a matrix, we'll indicate if it is a V, E or R matrix.



For concreteness, let us consider the specific case of $(m,n) = (2,3)$.
...
Fig.~\ref{fig:fig2} shows how the partial row sums behave and enter into the max part of
